...
function getMachineMetrics(machine: Machine) {
    ...
    switch (machine.type) {
        case 'Cutter':
            metrics.push({ icon: Thermometer, label: 'Temp', value: machine.temperature ? `${machine.temperature.toFixed(1)}°C` : '--', alert: machine.temperature ? machine.temperature > 150 : false });
